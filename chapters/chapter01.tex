...
En el Capítulo 3 se describe el estado del arte, donde se describen y analizan algunas de las técnicas existentes para el desarrollo del aprendizaje colaborativo, así mismo de presentan herramientas para el aprendizaje colaborativo y finalmente se describen algunos frameworks que permiten realiza aplicaciones web de tiempo real que ayudarán en la implementación del sistema propuesto en esta tesis.
