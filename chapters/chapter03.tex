...
\begin{figure}[!h]
  ...
  \fbox{\includegraphics[scale=0.4]{figuras/learncs}}\\  
  \source{ \citeNP {lipman_learncs_2014}  }
  \label{fig:learncs}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption[LearnCS]{Área gráfica para programas más interactivos en LearnCS!}
    ...
    \fbox{\includegraphics[scale=0.5]{figuras/learncs2}}\\
    \source{ \citeNP {lipman_learncs_2014}  }
      \label{fig:learncs2}
\end{figure}
...
\begin{figure}[!h]
  ...
  \caption[Google Docs]{Google Docs }
  \label{fig:googledocs}  
  \fbox{\includegraphics[scale=0.4]{figuras/googledocs.jpg}}\\
    \source{ \citeNP {googledocs}  }
\end{figure}

\clearpage
\subsection{Sistema Web para la enseñanza de Casos de Uso empleando la Técnica de Aprendizaje Cooperativo de Rompecabezas.}
...
\begin{figure}[h]
  ...
  \caption[CodeBunk]{Interfaz gráfica de Codebunk}
    \fbox{\includegraphics[scale=0.3]{figuras/codebunk}}\\
        \source{ \citeNP {codebunk}  }
  \label{fig:codebunk}
...
\begin{figure}[!h]
  ...
  \caption{Jigsaw Paso 1}{Fase de reunión de grupos de expertos. }
    \fbox{\includegraphics[scale=0.3]{figuras/jigsaw_ltpac_1}}\\
      \source{ \citeNP {Buhr2014429}  }
  \label{fig:jigsaw_ltpac_1}
\end{figure}

%Los objetivos del ejercicio jigsaw realizado fueron para definir LTPAC, identificar cuáles son los alcances de este tipo de servicios que se brindan a los pacientes y describir los roles de los miembros del equipo que laboraba en el asilo de ancianos. 
...
\begin{figure}[!h]
  ...
  \caption{Jigsaw Paso 2}{Fase de reunión de grupos Jigsaw dirigidos por un moderador.}
    ...
    \fbox{\includegraphics[scale=0.5]{figuras/jigsaw_ltpac_2}}\\
      \source{ \citeNP {Buhr2014429}  }
...
\begin{figure}[h]
  ...
  \caption{Pair Research}{Hoja de excel utilizada para la matriz de preferencias y emparejamiento.}
    \fbox{\includegraphics[scale=0.4]{figuras/pair_research}}\\
      \source{ \citeNP { miller_pair_2014}  }
...
\subsection{Mentored Pair Programming}
...
Pair Programming es un enfoque que mejora la calidad del diseño, reduce los defectos en el producto en desarrollo así como también mejora las habilidades técnicas y comunicativas del equipo de trabajo. De acuerdo con \citeA{han_enhancement_2010}, PP presenta algunos beneficios importantes como:\\
...
\begin{figure}[h]
  ...
  \caption[Ideone]{Interfaz gráfica de Ideone.}
    \fbox{\includegraphics[scale=0.5]{figuras/ideone.jpg}}\\
        \source{ \citeNP { ideone}  }
  \label{fig:ideone}
\end{figure}
...
La api de hangounts provee una interface para video llamadas. Provee una interface en JavaScript con la cual se puede listar los participantes del hangout y compartir data entre los mismos. Además, se puede manipular el micrófono y la cámara web de los miembros del hangout.
