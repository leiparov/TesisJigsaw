...
\begin{figure}[!h]
  ...
  \fbox{\includegraphics[scale=0.4]{figuras/learncs.png}}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.5]{figuras/learncs2.png}}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.8]{figuras/googledocs.jpg}}\\
...
\begin{figure}[h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.3]{figuras/codebunk.png}}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.3]{figuras/jigsaw_ltpac_1.png}}\\
...
\begin{figure}[!h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.5]{figuras/jigsaw_ltpac_2.png}}\\
...
\begin{figure}[h]
  \centering
  % Requires \usepackage{graphicx}
  \fbox{\includegraphics[scale=0.4]{figuras/pair_research.png}}\\
