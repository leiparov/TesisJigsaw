...
\begin{tabular}{|L{8cm}|C{2.5cm}|C{2.5cm}|}
  ...
  \hline
  Se aprende del compañero & \cmark & \cmark\\
  Permite las revisiones de trabajo constantes & \xmark & \cmark\\
  Desarrolla la creatividad & \cmark & \cmark\\
  Mejora las comunicación del estudiante & \cmark & \cmark\\
  Favorece la integración del grupo	& \cmark & \xmark\\
  Favorece el aprendizaje del tema a tratar & \cmark & \cmark\\
  Existe un método para generar los emparejamientos & \xmark & \cmark\\
  Se requiere la dirección de un profesor &	\cmark & \xmark	\\
  Permite evitar conflictos interpersonales & \xmark &	\cmark\\
  Favorece al trabajo con personas conocidas & \cmark & \cmark\\
  Favorece la integración con nuevas personas &	\cmark & \xmark \\	
  El alumno elige con quién trabajar & \xmark & \cmark\\		
  \hline
\end{tabular}
\caption{Jigsaw - Pair Research}
\label{tab:jigsaw-pairResearch}
\end{table}
...
\begin{landscape}
\begin{longtable}{|L{10cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|C{2.5cm}|}
\caption{Herramientas para el aprendizaje colaborativo}
\label{tab:herramientas}\\
    \hline
    CARACTERÍSTICAS	& LearnCS &	Google Docs & Sistema PUCP & Code Bunks\\	
    \hline
    Permite escribir código fuente C	&\cmark	&\cmark	&\xmark	&\cmark	\\
    Compila código fuente C	&\cmark	&\xmark	&\xmark	&\cmark	\\
    Permite depurar el código fuente C	&\cmark	&\xmark	&\xmark	&\xmark	\\
    Posee un representación de la memoria del computador	&\cmark	&\xmark	&\xmark	&\xmark	\\
    Muestra mensajes de error	&\cmark	&\xmark	&\xmark	&\cmark	\\
    Brinda coloreado de sintaxis de lenguaje C	&\cmark	&\xmark	&\xmark	&\cmark	\\
    Es un aplicativo web	&\cmark	&\cmark	&\cmark	&\cmark	\\
    Soporta sólamente lenguage C	&\cmark	&\xmark	&\xmark	&\xmark	\\
    Crear documentos básicos desde cero	&\xmark	&\cmark	&\xmark	&\xmark	\\
    Subir archivos ya creados	&\xmark	&\cmark	&\xmark	&\xmark	\\
    Edición de documentos de texto	&\xmark	&\cmark	&\cmark	&\cmark	\\
    Edición de hojas de cálculo	&\xmark	&\cmark	&\xmark	&\xmark	\\
    Edición de diapositivas	&\xmark	&\cmark	&\xmark	&\xmark	\\
    Compartir documentos	&\xmark	&\cmark	&\xmark	&\cmark	\\
    Chatear en tiempo real con otros usuarios	&\xmark	&\cmark	&\xmark	&\cmark	\\
    Exportar documentos 	&\xmark	&\cmark	&\xmark	&\xmark	\\
    Diseñar sesión de clase jigsaw	&\xmark	&\xmark	&\cmark	&\xmark	\\
    Tomar evaluaciones	&\xmark	&\xmark	&\cmark	&\xmark	\\
    Calificar evaluaciones	&\xmark	&\xmark	&\cmark	&\xmark	\\
    Foro de discusión	&\xmark	&\xmark	&\cmark	&\xmark	\\
    Elaborar casos de uso	&\xmark	&\xmark	&\cmark	&\xmark	\\
    Permite escribir código fuente de forma colaborativa	&\xmark	&\cmark	&\xmark	&\cmark	\\
    Soporta varios lenguajes de programación (14)	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Coloración de sintaxis por cada lenguaje de programación	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Indentado inteligente	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Compilador de código fuente	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Ejecución de código fuente	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Visualización de resultados de ejecución	&\xmark	&\xmark	&\xmark	&\cmark	\\
    Historial de revisiones de código	&\xmark	&\cmark	&\xmark	&\cmark	\\
    Creación de equipos colaborativos	&\xmark	&\cmark	&\xmark	&\cmark	\\
    \hline
\end{longtable}
\end{landscape}
