...
\begin{figure}[!h]
  ...
  \fbox{\includegraphics[scale=0.7]{figuras/rup.jpg}}\\
...
\begin{figure}[h!]
	...
	\label{fig:sjc_login}
	\fbox{\includegraphics[scale=0.4]{figuras/usodelsistema/login}}	
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.5]{figuras/usodelsistema/login_registrate}}	
\end{figure}
...
\label{fig:inicio}
\fbox{\includegraphics[scale=0.5]{figuras/usodelsistema/docente/inicio}}
\end{figure}
%\clearpage
...
\begin{enumerate}
	...
	\begin{figure}[h!]
		...
		\fbox{\includegraphics[scale=0.2]{figuras/usodelsistema/alumno/nota_de_examen}}
	\end{figure}
