...
\end{lstlisting}
\section{Aplicar el aporte al caso de estudio}
\subsection{Sesión Jigsaw}
...
\begin{enumerate}
 	...
 	\item Elaborar un programa que imprima la siguiente serie de asteriscos de forma vertical: * ** *** **** *****
\end{enumerate}
