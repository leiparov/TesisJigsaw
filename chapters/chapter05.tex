...
\fbox{\includegraphics[scale=0.4]{figuras/chapter05/creacion_problemas}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.4]{figuras/chapter05/creacion_alumnos}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.5]{figuras/chapter05/creacion_sesion_jigsaw}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.35]{figuras/chapter05/asignacion_alumnos}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.6]{figuras/chapter05/horario_reunion_expertos}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.6]{figuras/chapter05/horario_reunion_jigsaw}}
\end{figure}
...
\begin{figure}[h!]
	...
	\fbox{\includegraphics[scale=0.6]{figuras/chapter05/horario_examen}}
\end{figure}
